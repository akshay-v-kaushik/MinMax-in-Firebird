...
static_assert(sizeof(struct data_page) == 388, "struct data_page size mismatch");
...
static_assert(offsetof(struct data_page, dpg_rpt) == 384, "dpg_rpt offset mismatch");
